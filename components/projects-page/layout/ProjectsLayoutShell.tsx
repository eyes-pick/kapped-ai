      ...
      <ResizablePanelGroup direction="horizontal" className="flex-1 min-h-0">
        ...
        >
          <div className={clsx("h-full w-full flex flex-col", className)}>
            {/* Chat Header*/}
            <div id="chat-header" className="mx-auto p-1 w-[80%] sticky top-0">
              {chatHeader}
            </div>
            {/* Chat message stream */}
            <div
              id="message-stream"
              className="justify-self-start w-[90%] h-auto flex-1 overflow-y-auto"
            >
              {chatStream}
            </div>
            ...
            <div
              id="message-input"
              className="w-full flex flex-col bg-zinc-900 sticky bottom-0 z-10"
            >
              {chatToolbar}
              {chatInput}
            </div>
